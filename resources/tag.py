...
class LinkTagsToItems(MethodView):
    ...
    def post(self, item_id, tag_id):
        ...
        # here we treat the tags like a list, and the item model will automatically make
...
class Tag(MethodView):
    ...
    @blp.alt_response(400,
                      description="Returned if the tag is assigned to "
                                  "one or more items. In this case, the tag is"
                                  "not deleted."
                      )
